...
- Установленный [TrickyStore](https://github.com/5ec1cff/TrickyStore)
- Android 10+
...
**Кратко о последнем крупном обновлении (v4.1):** полный переход с одиночного скрипта на WebUI — отдельные функции с описаниями, автономный мониторинг keybox, мультиязычность, AMOLED-тема и информация об устройстве на главном экране.
